...
- 🔄 Backlog: expand caller archetype variations and add additional reference dialogue snippets.
- 🔄 Backlog: capture scenario-level humor boundary callouts and inclusive language examples.
