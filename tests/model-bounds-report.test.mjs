...
test('createBoundsSummary normalizes bounds payload', () => {
  const summary = createBoundsSummary({ filePath: 'desk.glb', scene: 1, bounds: sampleBounds }, { deskFootprint });
...
test('formatBoundsSummaries outputs text by default', () => {
  const summary = createBoundsSummary({ filePath: 'desk.glb', bounds: sampleBounds }, { deskFootprint });
